...
public class Users {
    ...
    @JsonProperty("id_client")   // ← force le nom dans le JSON
    ...
    @JsonIgnore
    public List<Dechet> getDechets() { return dechets; }
    public void setDechets(List<Dechet> dechets) { this.dechets = dechets; }

    @JsonIgnore
    public List<Conseil> getConseils() { return conseils; }
    public void setConseils(List<Conseil> conseils) { this.conseils = conseils; }
}